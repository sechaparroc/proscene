...
public class AnimatorObject implements Animator {
 ...
 @Override public TimingHandler timingHandler() {
  return handler;
 }

 @Override public SeqTimer timer() {
  ...
  * @see #animate()
  */
 @Override public boolean animationStarted() {
  return started;
 }
  ...
  */
 @Override public long animationPeriod() {
  ...
  * @see #setAnimationPeriod(long, boolean)
  */
 @Override public void setAnimationPeriod(long period) {
  ...
  * @see #startAnimation()
  */
 @Override public void setAnimationPeriod(long period, boolean restart) {
  if (period > 0) {
  ...
  */
 @Override public void restartAnimation() {
  stopAnimation();
  startAnimation();
 }
  ...
  */
 @Override public void toggleAnimation() {
  if (animationStarted())
   stopAnimation();
  else
   startAnimation();
