...
public class MouseAgent extends Agent {
  public static final int LEFT_ID = Scene.registerMotionID(37, 2), CENTER_ID = Scene.registerMotionID(3, 2),
      RIGHT_ID = Scene.registerMotionID(39, 2), WHEEL_ID = Scene.registerMotionID(8, 1),
