...
public class InteractiveFrame extends GenericFrame {
 ...
 @Override public InteractiveFrame get() {
  return new InteractiveFrame(this);
 }

 @Override protected InteractiveFrame detach() {
  ...
  */
 @Deprecated public void fromFrame(InteractiveFrame otherFrame) {
 ...
 @Override public void setPickingPrecision(PickingPrecision precision) {
  ...
  * @see #isEyeFrame()
  */
 @Override public final boolean checkIfGrabsInput(float x, float y) {
  if (isEyeFrame()) {
  ...
  */
 @Override public boolean checkIfGrabsInput(KeyboardEvent event) {
  ...
  */
 @Deprecated public void addGraphicsHandler(Object obj, String methodName) {
  setShape(obj, methodName);
 }
  ...
  */
 @Deprecated public void removeGraphicsHandler() {
  resetShape();
 }
  ...
  */
 @Deprecated public PShape shape() {
  return fShape.shp;
 }
}