...
public class MatrixStackHelper extends MatrixHelper {
 ...
 @Override public void pushModelView() {
 ...
 @Override public void popModelView() {
 ...
 @Override public void resetModelView() {
  modelview.reset();
 }

 @Override public Mat modelView() {
  return modelview.get();
 }

 @Override public Mat getModelView(Mat target) {
  if (target == null)
   target = new Mat();
 ...
 @Override public void printModelView() {
  modelview.print();
 }

 @Override public void setModelView(Mat source) {
  resetModelView();
  applyModelView(source);
 }

 @Override public void applyModelView(Mat source) {
 ...
 @Override public void translate(float tx, float ty, float tz) {
 ...
 @Override public void rotate(float angle, float v0, float v1, float v2) {
  modelview.rotate(angle, v0, v1, v2);
 }

 @Override public void scale(float s) {
  scale(s, s, s);
 }
 ...
 @Override public void pushProjection() {
 ...
 @Override public void popProjection() {
 ...
 @Override public void setProjection(Mat source) {
  resetProjection();
  applyProjection(source);
 }

 @Override public void resetProjection() {
  projection.reset();
 }

 @Override public void applyProjection(Mat source) {
  projection.apply(source);
 }

 @Override public Mat projection() {
  return projection.get();
 }

 @Override public Mat getProjection(Mat target) {
  if (target == null)
   target = new Mat();
 ...
 @Override public void printProjection() {
  projection.print();
 }
}
