...
public class GenericFrame extends Frame implements Grabber, Trackable {
 ...
 @Override public GenericFrame get() {
 ...
 @Override public GenericFrame referenceFrame() {
  return (GenericFrame) this.refFrame;
 }

 @Override public void setReferenceFrame(Frame frame) {
  ...
  */
 @Override protected void modified() {
 ...
 @Override public void rotateAroundFrame(float roll, float pitch, float yaw, Frame frame) {
  if (frame != null) {
   Frame ref = frame.get();
  ...
  */
 @Deprecated public void setGrabsInputThreshold(float threshold, boolean adaptive) {
  if (isEyeFrame()) {
  ...
  * @see remixlab.dandelion.core.AbstractScene#setAvatar(Trackable)
  */
 @Override public GenericFrame trackingEyeFrame() {
  return eFrame;
 }
}
