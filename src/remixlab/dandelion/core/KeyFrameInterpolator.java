...
public class KeyFrameInterpolator implements Copyable {
 ...
 protected class KeyFrame3D extends KeyFrame {
  ...
  @Override public KeyFrame3D get() {
  ...
  @Override void computeTangent(KeyFrame prev, KeyFrame next) {
 ...
 protected class KeyFrame2D extends KeyFrame {
  ...
  @Override public KeyFrame2D get() {
 ...
 @Override public KeyFrameInterpolator get() {
