...
public abstract class Eye implements Copyable {
 class GrabberEyeFrame extends GenericFrame {
  ...
  @Override public GrabberEyeFrame get() {
   return new GrabberEyeFrame(this);
  }

  @Override protected GrabberEyeFrame detach() {
  ...
  @Override public void performInteraction(MotionEvent event) {
  ...
  @Override public void performInteraction(ClickEvent event) {
  ...
  @Override public void performInteraction(KeyboardEvent event) {
 ...
 @Override public abstract Eye get();
