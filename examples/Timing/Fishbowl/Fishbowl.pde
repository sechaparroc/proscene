 ...
 *
 * This example is based on the Flock example. Here each entity (in this case a fish)
 * has the following features:
 *
 * 1. It joins a Flock according to a happiness function based on shape and color
 ...
 *           used when fishes seems to not converge in flocks).
